...
class InternalTimerTests(unittest.TestCase):
    def test_internal_time_starts_at_zero(self):
        timer = InternalTimer()
        self.assertEqual(timer.internal_time, 0)
    ...
    def test_multiple_context_managers_accumulate_elapsed_time(self):
        ...
        self.assertAlmostEqual(timer1.internal_time, 0.1, places=1)
        self.assertAlmostEqual(timer2.internal_time, 0.2, places=1)
    ...
    def test_nested_context_managers_accumulate_elapsed_time(self):
        ...
        self.assertAlmostEqual(timer1.internal_time, 0.3, places=1)
        self.assertAlmostEqual(timer2.internal_time, 0.2, places=1)
